...
@section('content')
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        <h5 class="fs-4 fw-bolder text-black">Categories</h5>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Dashboard</a></li>
                <li class="breadcrumb-item active text-black-50" aria-current="page">Categories</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="wg-box">
        <div class=" row  justify-content-between align-items-content mb-3">
            ...
            <div class="col-4 col-md-3 col-xl-2 ">
                <a href="{{ route('admin.category.create') }}" class="btn btn-outline-primary w-100 py-2">+ Add new</a>
            </div>
        </div>
        <div class="wg-table">
